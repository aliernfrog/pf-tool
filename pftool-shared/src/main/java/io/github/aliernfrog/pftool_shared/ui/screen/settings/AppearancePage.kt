...
fun AppearancePage(
    ...
    SettingsPageContainer(
        title = sharedStringResource(SharedString.SETTINGS_APPEARANCE),
        onNavigateBackRequest = onNavigateBackRequest
    ) {
        ExpressiveSection(
            title = sharedStringResource(SharedString.SETTINGS_APPEARANCE_THEME)
        ) {
            Row(
        ...
        ExpressiveSection(
            title = sharedStringResource(SharedString.SETTINGS_APPEARANCE_COLORS)
        ) {
            VerticalSegmentor(
                {
                    ExpressiveSwitchRow(
                        title = sharedStringResource(SharedString.SETTINGS_APPEARANCE_COLORS_MATERIAL_YOU),
                        description = sharedStringResource(
                            if (supportsMaterialYou) SharedString.SETTINGS_APPEARANCE_COLORS_MATERIAL_YOU_DESCRIPTION
                            else SharedString.SETTINGS_APPEARANCE_COLORS_MATERIAL_YOU_UNAVAILABLE
                        ),
                        icon = {
                            ExpressiveRowIcon(
                    ...
                    ExpressiveSwitchRow(
                        title = sharedStringResource(SharedString.SETTINGS_APPEARANCE_COLORS_PITCH_BLACK),
                        description = sharedStringResource(SharedString.SETTINGS_APPEARANCE_COLORS_PITCH_BLACK_DESCRIPTION),
                        icon = {
                            ExpressiveRowIcon(
