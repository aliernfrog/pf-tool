...
@Composable
fun PickMapSheet(state: ModalBottomSheetState, onMapPick: (String) -> Unit) {
...
@OptIn(ExperimentalMaterialApi::class)
@Composable
fun PickFromDeviceButton(state: ModalBottomSheetState, onMapPick: (String) -> Unit) {
    val context = LocalContext.current
    ...
    PFToolButton(title = context.getString(R.string.manageMapsPickMapFromDevice), painter = painterResource(id = R.drawable.device)) {
