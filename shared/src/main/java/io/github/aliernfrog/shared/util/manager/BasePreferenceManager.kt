package io.github.aliernfrog.shared.util.manager
...
abstract class BasePreferenceManager(
    ...
    open fun getBoolean(key: String, defaultValue: Boolean) = prefs.getBoolean(key, defaultValue)
    open fun getInt(key: String, defaultValue: Int) = prefs.getInt(key, defaultValue)
    ...
    open fun putBoolean(key: String, value: Boolean) = prefs.edit { putBoolean(key, value) }
    open fun putInt(key: String, value: Int) = prefs.edit { putInt(key, value) }
