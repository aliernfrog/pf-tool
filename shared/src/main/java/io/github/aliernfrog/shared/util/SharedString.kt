...
open class SharedString(
    ...
    data object CrashHandlerSendReportSent : SharedString("crashHandler_sendReport_sent")
    data object CrashHandlerRestartApp : SharedString("crashHandler_restartApp")
